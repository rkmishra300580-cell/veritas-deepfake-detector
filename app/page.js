    ...
    <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0, overflow: 'hidden' }}>
      {bubbles.map((b, i) => (
        <div key={i} style={{
          ...
          height: b.size,
          borderRadius: '50%',
          background: `radial-gradient(circle at 35% 35%, rgba(255,255,255,${b.opacity}) 0%, rgba(45,212,191,0.08) 55%, transparent 75%)`,
          border: '1px solid rgba(45,212,191,0.18)',
          backdropFilter: 'blur(2px)',
          animation: `floatBubble ${b.dur} ease-in-out infinite`,
          animationDelay: b.delay,
          boxShadow: `inset 0 1px 0 rgba(255,255,255,0.6), 0 8px 32px rgba(45,212,191,0.06)`,
        }} />
      ))}
    </div>
  );
    ...
    <>
      ...
      <div style={{ position: 'relative', width: '100%', height: 420, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          return (
            ...
            >
              {src
                ...
                : <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 8, color: '#94a3b8', textAlign: 'center', padding: 2 }}>DEMO</div>
              }
            </div>
          );
        })}
          ...
          {imgSrc(graphs[active])
            ? <>
                ...
                <button onClick={() => setLightbox(imgSrc(graphs[active]))} style={{
                  ...
                  cursor: 'pointer', color: '#334155', display: 'flex', alignItems: 'center', gap: 4, fontSize: 11,
                }}>
                  <ZoomIn size={11} /> Full
                </button>
              </>
            : <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                <div style={{ fontSize: 11, color: '#94a3b8', fontFamily: 'monospace' }}>[ demo mode ]</div>
                <div style={{ fontSize: 12, color: '#cbd5e1', textAlign: 'center', padding: '0 16px' }}>{graphs[active].title}</div>
              </div>
          }
        </div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 12, fontWeight: 600, color: '#0f766e', marginBottom: 2 }}>
            {graphs[active].title}
          </div>
        ...
        <div style={{ position: 'absolute', top: 10, left: '50%', transform: 'translateX(-50%)', display: 'flex', gap: 6 }}>
          {graphs.map((_, i) => (
            <div key={i} onClick={() => setActive(i)} style={{
              ...
              background: i === active ? '#2dd4bf' : '#cbd5e1',
  ...
  return (
    <div style={{ position: 'relative', width: 140, height: 140 }}>
      ...
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ fontSize: 9, color: '#94a3b8', letterSpacing: 1, marginTop: 2 }}>% FAKE</div>
      </div>
    </div>
  );
}
...
function ScanStages({ progress }) {
  ...
  return (
    <div style={{ maxWidth: 380, margin: '0 auto', width: '100%' }}>
        ...
        return (
          <div key={i} style={{
            ...
            <div style={{
              ...
              background: done ? '#2dd4bf' : active ? '#2dd4bf' : '#e2e8f0',
            ...
            <span style={{
              fontSize: 13, flex: 1,
              color: done ? '#1e293b' : active ? '#1e293b' : '#94a3b8',
            }}>{s.label}</span>
            {/* status */}
            <span style={{
      ...
      {/* thin progress bar */}
      <div style={{ marginTop: 20, height: 2, background: 'rgba(0,0,0,0.06)', borderRadius: 2, overflow: 'hidden' }}>
...
export default function VeritasApp() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f0f7f6', color: '#1e293b', fontFamily: "'Inter',-apple-system,sans-serif", overflowX: 'hidden' }}>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap');
        *{box-sizing:border-box;margin:0;padding:0;}
        ::selection{background:#2dd4bf;color:#fff;}
        ...
        .btn-ghost{background:transparent;color:#64748b;border:1px solid #e2e8f0;border-radius:6px;padding:11px 18px;font-size:13px;cursor:pointer;transition:all 0.2s;}
        .btn-ghost:hover{border-color:#2dd4bf;color:#1e293b;}
        .card{background:#fff;border:1px solid rgba(0,0,0,0.06);border-radius:12px;box-shadow:0 2px 12px rgba(0,0,0,0.04);}
      ...
      <header style={{
        ...
        background: 'rgba(240,247,246,0.88)', backdropFilter: 'blur(16px)',
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            ...
            <span style={{ fontWeight: 800, fontSize: 22, letterSpacing: -0.5, color: '#0f172a', lineHeight: 1 }}>Darpan</span>
          </div>
          <span className="mono" style={{ fontSize: 10, color: '#94a3b8', border: '1px solid #e2e8f0', padding: '2px 7px', borderRadius: 4, alignSelf: 'flex-end', marginBottom: 2 }}>FORENSIC ENGINE v5</span>
        </div>
      ...
      <main style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', padding: '0 24px 48px' }}>
        ...
        {stage === 'upload' && (
          <div style={{ animation: 'fadeIn 0.4s ease', paddingTop: 64 }}>
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
              ...
              <h1 style={{ fontSize: 42, fontWeight: 700, letterSpacing: -1.5, lineHeight: 1.1, marginBottom: 16, color: '#0f172a' }}>
            ...
            <div
              ...
              style={{
                ...
                background: dragActive ? 'rgba(45,212,191,0.04)' : 'rgba(255,255,255,0.7)',
            ...
            >
              ...
              {file
                ? <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                    ...
                    <div className="mono" style={{ fontSize: 12, color: '#94a3b8' }}>{formatBytes(file.size)}</div>
                  </div>
                : <>
                    <Upload size={28} color="rgba(45,212,191,0.6)" style={{ marginBottom: 14 }} />
                    <div style={{ fontSize: 16, fontWeight: 500, marginBottom: 6, color: '#1e293b' }}>Drop a file here, or click to browse</div>
                    <div style={{ fontSize: 13, color: '#94a3b8' }}>JPG · PNG · MP4 · MOV · MP3 · WAV · PDF · DOCX — up to 500 MB</div>
                  </>
              }
            </div>
        ...
        {stage === 'scanning' && (
          <div style={{ paddingTop: 80, animation: 'fadeIn 0.3s ease' }}>
            <div style={{ textAlign: 'center', marginBottom: 36 }}>
              ...
              <div style={{ fontSize: 15, color: '#1e293b', fontWeight: 500 }}>{file?.name}</div>
            </div>
        ...
        {stage === 'error' && (
          <div className="card" style={{ maxWidth: 480, margin: '80px auto', padding: 40, textAlign: 'center', borderColor: 'rgba(239,68,68,0.2)', animation: 'fadeIn 0.3s ease' }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8, color: '#1e293b' }}>Analysis failed</div>
          ...
          <div style={{ animation: 'fadeIn 0.5s ease', paddingTop: 32 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 16, marginBottom: 16 }}>
              ...
              <div className="card" style={{ padding: 24, borderColor: `${cfg.color}15` }}>
                <p style={{ fontSize: 14, color: '#334155', lineHeight: 1.7, marginBottom: 20 }}>{result.verdict}</p>
                {result.stage_scores && (
                  <div style={{ display: 'grid', gridTemplateColumns: `repeat(${Object.keys(result.stage_scores).filter(k => result.stage_scores[k] !== null).length}, 1fr)`, gap: 10 }}>
                    {Object.entries(result.stage_scores).map(([k, v]) => v !== null && (
                      <div key={k} style={{ background: '#f8fafc', borderRadius: 8, padding: '12px 14px', borderLeft: `3px solid ${v >= 50 ? '#d97706' : '#059669'}` }}>
                        <div style={{ fontSize: 10, color: '#94a3b8', textTransform: 'capitalize', marginBottom: 4, letterSpacing: 0.5 }}>{k.replace(/_/g,' ')}</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 16, marginBottom: 16 }}>
              ...
              <div className="card" style={{ padding: '16px 0 0', overflow: 'hidden' }}>
                <div style={{ padding: '0 20px 12px', fontSize: 11, color: '#94a3b8', letterSpacing: 1, textTransform: 'uppercase' }}>Visual analysis</div>
                {result.graphs?.length > 0
                  ? <OrbitCarousel graphs={result.graphs} jobId={result.job_id} isMock={isMock} />
                  : <div style={{ height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#cbd5e1', fontSize: 13 }}>No graphs available</div>
                }
              </div>

              {/* Indicators */}
              <div className="card" style={{ padding: 20, display: 'flex', flexDirection: 'column' }}>
                <div style={{ fontSize: 11, color: '#94a3b8', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 14 }}>
                  ...
                  {result.indicators?.length > 0
                    ? result.indicators.map((ind, i) => (
                        <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 8, padding: '8px 10px', background: 'rgba(217,119,6,0.04)', border: '1px solid rgba(217,119,6,0.12)', borderRadius: 6 }}>
                          ...
                          <span style={{ fontSize: 12, color: '#334155', lineHeight: 1.5 }}>{ind}</span>
                        </div>
                      ))
                    : <div style={{ fontSize: 13, color: '#94a3b8', textAlign: 'center', marginTop: 40 }}>No suspicious indicators detected</div>
                  }
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              {result.stats?.length > 0 && (
                <div className="card" style={{ padding: 20 }}>
                  <div style={{ fontSize: 11, color: '#94a3b8', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 14 }}>Detailed metrics</div>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                    {result.stats.map((s, i) => (
                      <div key={i} style={{ padding: '10px 12px', background: '#f8fafc', borderRadius: 6 }}>
                        <div style={{ fontSize: 10, color: '#94a3b8', marginBottom: 3 }}>{s.label}</div>
                        <div className="mono" style={{ fontSize: 13, color: '#1e293b' }}>{s.value}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {/* File evidence */}
              <div className="card" style={{ padding: 20 }}>
                <div style={{ fontSize: 11, color: '#94a3b8', letterSpacing: 1, textTransform: 'uppercase', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 6 }}>
                  <Lock size={11} /> File evidence
                </div>
                <div className="mono" style={{ fontSize: 11, color: '#64748b', lineHeight: 2.2 }}>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>FILE</span>
                    <span style={{ color: '#1e293b' }}>{result.filename}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>SIZE</span>
                    <span>{formatBytes(result.metadata?.size_bytes)}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>MIME</span>
                    <span>{result.metadata?.mime}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>MD5</span>
                    <span style={{ wordBreak: 'break-all', fontSize: 10 }}>{result.metadata?.md5}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>JOB</span>
                    <span>{result.job_id}</span>
                  </div>
                  <div style={{ display: 'flex', gap: 12 }}>
                    <span style={{ color: '#cbd5e1', minWidth: 56 }}>TIME</span>
